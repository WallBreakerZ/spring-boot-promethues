...
public class PdfConvert {
    ...
    public static void main(String[] args) throws IOException, ExecutionException, InterruptedException, TimeoutException {
        ...
        for (int k = 0; k < 20; k++) {
            try (PDDocument document = PDDocument.load(new File("C:\\Users\\50317\\Desktop\\合同文件测试.pdf"));) {
                ...
                // 补丁,多线程时第一次调用有问题，
//            if (!isInit) {
//                pdfRenderer.renderImageWithDPI(0, 130, ImageType.RGB);
//                isInit = true;
//            }
...
//                                 new FileOutputStream("C:\\Users\\50317\\Desktop\\图片\\" + imageFileName);
